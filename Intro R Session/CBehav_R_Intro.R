...
#dicerolls.csv available at https://github.com/demartsev/KRC_CBehv/blob/master/Intro%20R%20Session/dicerolls.csv
#Lervik.csv available at https://github.com/demartsev/KRC_CBehv/blob/master/Intro%20R%20Session/Lervik.csv
#Navrean.csv available at https://github.com/demartsev/KRC_CBehv/blob/master/Intro%20R%20Session/Navrean.csv
#Okno.csv available at https://github.com/demartsev/KRC_CBehv/blob/master/Intro%20R%20Session/Okno.csv

#first create a list of the packages needed for the course
...
#then install them using lapply 
lapply(packages, FUN = install.packages, character.only = TRUE)

#load in packages to the R environment
library(chron)
library(sp)
library(raster)
library(rgeos)
